package com.looky.domain.favorite.controller;
...
@Tag(name = "Student Favorite", description = "학생 단골 상점(즐겨찾기) API")
@RestController
...
public class StudentFavoriteController {
    ...
    @Operation(summary = "[학생] 상점 즐겨찾기 수 조회", description = "특정 상점의 총 단골 수를 조회합니다.")
    @ApiResponses(value = {
