...
@Getter
@Builder
public class StudentStoreResponse {
    private Long id;
    private Long userId;
    private String name;
    ...
    private List<PartnershipInfo> myPartnerships; // 없으면 빈 리스트
    private CloverGrade cloverGrade;
    private String profileImageUrl;

    public static StudentStoreResponse of(Store store, Double averageRating, Integer reviewCount, List<PartnershipInfo> myPartnerships, CloverGrade cloverGrade) {
        return StudentStoreResponse.builder()
                .id(store.getId())
